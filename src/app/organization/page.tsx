...
export default async function OrganizationWorkspacePage({
  ...
  const administrationHref = organizationId
    ...
    <main className="min-h-screen bg-gray-200 px-6 py-8 lg:px-8 lg:py-10">
      <div className="mx-auto max-w-7xl space-y-8">
        ...
        <header className="flex flex-col gap-5 lg:flex-row lg:items-start lg:justify-between">
          <div>
            ...
            <p className="mt-2 max-w-3xl text-muted-foreground">
              Administer your organization&apos;s people, structure,
              performance system, analytics, and configuration.
            </p>
          </div>
            ...
            <div>
              ...
              {!organization && (
                <p className="mt-2 text-sm text-muted-foreground">
                  Select an organization from the development workspace
                  before entering Organization Admin.
                </p>
              )}
            </div>
          ...
          {!organization && (
            <div className="mt-5 rounded-lg border border-dashed bg-gray-50 p-5">
              <p className="text-sm text-muted-foreground">
                No organization context is currently available. During
                this development phase, select an organization from the
                main workspace before entering Organization Admin.
              </p>
        ...
        >
          ...
          <WorkspaceCard
            title="🚀 Initiatives"
            description="Manage initiatives associated with Key Results in your organization&apos;s Performance Sheets."
            href={workspaceHref(
